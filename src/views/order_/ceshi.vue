        ...
        >
          ...
          <el-table-column label="数量/单价/合计">
            <template slot-scope="scope">
              ...
              <div>原价: {{ scope.row.pro_cost_price1 }}元</div>
          ...
          <el-table-column label="操作" width="100" >
            <template slot-scope="scope">
              ...
              <el-button
                ...
                type="primary"
                style="margin-top:10px"
                v-show="scope.row.status == '2' && scope.row.refund_status != 2"
